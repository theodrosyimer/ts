...
declare function pipe<Fns extends any[]>(
  ...args: Piper<Fns>
...
type IsInfinite<N extends number> = Iterator<N> extends infer I
...
type PipeItem<Fns extends Arrow[], K extends keyof Fns> = NumberOf<K> extends 0
...
declare function compose<Fns extends any[]>(
  ...args: Composer<Fns>
...
> = NumberOf<K> extends Length<Tail<Fns>>
  ? Fns[K]
  : (
      arg: ReturnType<Fns[Pos<Next<IteratorOf<K>>>]>
    ) => ReturnType<Fns[Pos<IteratorOf<K>>]>
...
declare function curriedPipe<Fns extends Arrow[]>(
  ...fns: Piper<Fns>
): CurriedPipe<Fns>
declare function curriedCompose<Fns extends Arrow[]>(
  ...fns: Composer<Fns>
): CurriedCompose<Fns>
